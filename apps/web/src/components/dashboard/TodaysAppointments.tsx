...
export function TodaysAppointments() {
  ...
  return (
    <Card className="mb-8">
      <CardHeader>
        <CardTitle className="text-xl font-semibold">Citas de hoy</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-5 gap-4 mb-6">
          ...
          <div className="text-center">
            <div className="text-sm font-medium text-muted-foreground mb-1">Completadas</div>
            <div className="text-2xl font-bold">{mockStats.completed}</div>
          </div>
          <div className="text-center">
            <div className="text-sm font-medium text-muted-foreground mb-1">Vencidas</div>
            <div className="text-2xl font-bold">{mockStats.overdue}</div>
          </div>
          <div className="text-center">
            <div className="text-sm font-medium text-muted-foreground mb-1">Restantes</div>
        ...
        <div className="bg-muted/30 rounded-lg p-8 text-center">
          <p className="text-muted-foreground mb-6">
            Aquí es donde obtendrás una descripción general de tus citas para hoy una vez que estén programadas.
          </p>
