...
function TextInput({ label, type = 'text', description, labelProps, ...props }: { label: string, type?: 'text' | 'password' | 'number' | 'datetime-local', description?: string, labelProps?: React.ComponentProps<"label"> } & React.ComponentProps<"input">) {
